...
$message.= '</tbody></table>';
$message.= '<h2>Total de la comprada: '.$total.'</h2>';
$message.= '<a href="http://localhost/carrito/verpedido.php?id_venta='.$id_venta.'" style="background-color:brown; color:white; padding: 10px;">Ver el Status del pedido</a></body></html>';
