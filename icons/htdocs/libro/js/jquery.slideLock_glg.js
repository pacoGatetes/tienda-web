...
(function($) {
	...
	$.fn.slideLock = function(options) {
		...
		function insertLocker() {
			...
			uiHTML += '<div id="slider_captcha" title="Desplaza para desbloquear o formulario"></div></p>';
			uiHTML += '<p class="quiet"><span id="locked">' + opts.lockText + '</span><img src="' + opts.iconURL + '" alt="Desplaza á derecha" /><span id="unlocked">' + opts.unlockText + '</span></p>';
