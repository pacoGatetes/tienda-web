...
var existe_idioma=ruta.indexOf('/por/');
if (existe_idioma!=-1){
...
$.extend($.validator, {
	...
	messages: {
		  ...
		  email: "Por favor insira un email v&aacute;lido",
		  ...
		  digits: "Por favor, escribe s&oacute;lo d&iacute;gitos num&eacute;ricos.",
...
$.extend($.validator, {
	...
	messages: {
		  ...
		  remote: "Por favor, cumplimente esta campo.",
		  email: "Por favor, escribe un e-mail v&aacute;lido",
		  ...
		  number: "Por favor, escribe un número enteiro v&aacute;lido.",
		  digits: "Por favor, escribe so d&iacute;gitos num&eacute;ricos.",
		  creditcard: "Por favor, escribe un número de tarjeta válido.",
		  equalTo: "Por favor, escribe el mismo valor de nuevo.",
		  accept: "Por favor, escribe una valor con una extensión aceptada.",
		  maxlength: jQuery.validator.format("Por favor, no escribas más de {0} caracteres."),
